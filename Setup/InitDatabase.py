...
cursor.execute('''create table if not exists TestResult (
                    ...
                    StrengthTestEnabled text,
                    StrengthTestPassed text,
                    StrengthTestResult text,
                    StrengthTestDuration text,
                    StrengthTestPlanPressure text,
                    StrengthTestFactPressure text,
                    SealedTestEnabled text,
                    SealedTestPassed text,
                    SealedTestResult text,
                    SealedTestDuration text,
                    SealedTestPlanPressure text,
