...
class ReceiptView(QWidget):
    ...
    def __init__(self,parent = None,receiptModel=None):
        ...
        self.buttonNew.setStyleSheet(stylesheets.SVC_Button)
        self.buttonSave = QPushButton(Config.RC_SAVE)
        self.buttonSave.setStyleSheet(stylesheets.SVC_Button)
        self.buttonDelete = QPushButton(Config.RC_DELETE)
        self.buttonDelete.setStyleSheet(stylesheets.SVC_Button)
        hBox = QHBoxLayout()
