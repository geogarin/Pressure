...
class QRoundProgressBar(QWidget):
    ...
    def __init__(self):
        ...
        self.setStyleSheet(stylesheets.DefaultBackgroundColor)
    ...
    def drawBackground(self, p, baseRect):
        ...
        #p.fillRect(baseRect, self.palette().setColor())
        pass
    ...
    def drawValue(self, p, baseRect, value, arcLength):
        ...
        #p.setPen(QtGui.QPen(QtCore.Qt.white, self.dataPenWidth))
        p.drawPath(dataPath)
    ...
    def drawInnerBackground(self, p, innerRect):
        if self.barStyle == self.StyleDonut:
            ...
            p.setBrush(QtGui.QColor(stylesheets.TimerInnerBackGround[0],stylesheets.TimerInnerBackGround[1],stylesheets.TimerInnerBackGround[2]))
    ...
    def drawText(self, p, innerRect, innerRadius, value):
        ...
        f.setPixelSize(innerRadius * 1.8 / (len(text)+1))
        #print(f'pixel size {innerRadius * 1.8 / len(text)} {text}')
        p.setFont(f)
